import { SendEmailVerificationParams } from '@/src/types/email.types'
import {
  Body,
  Button,
  Container,
      ...
      >
        ...
        >
          ...
          <Section style={{ padding: '0' }}>
            ...
            >
              Gracias <strong>{email}</strong> por iniciar el proceso de
              creación de una nueva cuenta de Apex Rivals. Queremos asegurarnos
              de que realmente eres tú. Si no deseas crear una cuenta, puedes
